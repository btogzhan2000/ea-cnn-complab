...
class InceptionBlock(Unit):
    def __init__(self, number, in_channel, out_1x1, red_3x3, out_3x3, red_5x5, out_5x5, out_1x1pool): 
        super().__init__(number)
        self.type = 4
        # self.amount = amount
        self.in_channel = in_channel
...
class Individual(object):
    ...
    def initialize(self):
        ...
        for i in all_positions:
            if i == 1:
                ...
                inception = self.init_an_inception(_number=None, in_channels=input_channel, out_1x1=64, red_3x3=96, out_3x3=128, red_5x5=16, out_5x5=32, out_1x1pool=32)
    ...
    def init_an_inception(self, _number, in_channels, out_1x1, red_3x3, out_3x3, red_5x5, out_5x5, out_1x1pool):
        if _number:
            number = _number
        else:
            number = self.number_id
        ...
        inception = InceptionBlock(number, in_channels, out_1x1, red_3x3, out_3x3, red_5x5, out_5x5, out_1x1pool)
        return inception
